...
public class ProductDaoImpl implements  ProductDao{
    ...
    public  void dailySellingReport(){
        ...
        System.out.print("Enter date you want to find list of sold items \nExample : (YYYY-MM-DD): ");
        String date=sc.next();
        try {
    ...
    public  void updateProductlist(){
        Scanner sc =new Scanner(System.in);
        System.out.print("Enter productId of product you want to update: ");
        int productId=sc.nextInt();
    ...
    public  void deleteProductitem(){
        Scanner sc =new Scanner(System.in);
        System.out.print("Enter productId of product you want to delete: ");
        int productId=sc.nextInt();
